    ...
    function ($document, $compile, $rootScope, $controller, $timeout) {
        ...
        return function Dialog(templateUrl/*optional*/, options, passedInLocals) {
            ...
            var modalEl = angular.element(
                '<div class="' + options.modalClass + ' fade"' + idAttr + ' style="display: block;" ng-style="{\'z-index\': 1050 + index * 10, display: \'block\'}">' +
            ...
            if (options.backdropCancel) {
                divHTML += 'ng-click="$modalCancel()" ng-style="{\'z-index\': 1040 + index * 10, display: \'block\'}">';
            }
            divHTML += ">";
            ...
            scope.index = options.index || defaults.index;
